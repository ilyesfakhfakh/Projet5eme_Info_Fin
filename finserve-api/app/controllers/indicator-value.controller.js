...
router.post('/indicator-values/bulk', async (req, res) => {
  try {
...
router.get('/indicator-values/:valueId', async (req, res) => {
  try {
...
router.put('/indicator-values/:valueId', async (req, res) => {
  try {
    const { valueId } = req.params
...
router.delete('/indicator-values/:valueId', async (req, res) => {
  try {
    const { valueId } = req.params
...
router.get('/indicator-values/indicator/:indicatorId', async (req, res) => {
  try {
...
router.get('/indicator-values/indicator/:indicatorId/range', async (req, res) => {
  try {
    const { indicatorId } = req.params
...
router.get('/indicator-values/indicator/:indicatorId/latest', async (req, res) => {
  try {
    const { indicatorId } = req.params
...
router.get('/indicator-values/signal/:signal', async (req, res) => {
  try {
...
router.delete('/indicator-values/indicator/:indicatorId', async (req, res) => {
  try {
    const { indicatorId } = req.params
