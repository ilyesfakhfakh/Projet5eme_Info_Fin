...
export default function TotalGrowthBarChart({ isLoading }) {
  ...
  }, [fontFamily, theme.vars.palette.primary.light, theme.vars.palette.secondary.light, theme.vars.palette.success.main, theme.vars.palette.orange.main, textPrimary, grey500, divider]);
